# -*- coding: utf-8 -*-
#
# php-crypto-params documentation build configuration file, created by
# sphinx-quickstart on Sat Jan 16 15:46:12 2016.
#
...
htmlhelp_basename = 'php-crypto-paramsdoc'
...
latex_documents = [
    (master_doc, 'php-crypto-params.tex', u'php-crypto-params Documentation',
...
man_pages = [
    (master_doc, 'php-crypto-params', u'php-crypto-params Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'php-crypto-params', u'php-crypto-params Documentation',
     author, 'php-crypto-params', 'One line description of project.',
     'Miscellaneous'),
]
